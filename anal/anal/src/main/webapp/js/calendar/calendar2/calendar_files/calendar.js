...
// $Id: calendar.js,v 1.1 2010/02/01 04:17:09 zhanglm Exp $
...
　　					str = str.replace(/\s*$/, "");
			...
			if (t12){
				...
				part.innerHTML=Calendar._TT["OKBUTTON"] || "&nbsp;";
				part.className = "ampm";
				...
				var part = Calendar.createElement("span", cell);
				part.innerHTML=Calendar._TT["CLEAR"] || "&nbsp;";
				part.className = "ampm";
				part.onclick=function(){
					cal.sel.value =""; 
					cal.callCloseHandler();
...
Calendar.prototype._init = function (firstDayOfWeek, date) {
	...
	// PROFILE
//	this.tooltips.innerHTML = "鼠标点击在时间控件上左右滑动可以快速调整时间值";
};
