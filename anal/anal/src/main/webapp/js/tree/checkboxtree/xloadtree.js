...
function WebFXLoadTree(sText, sIdentifier, sIsRootCheckBox, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon) {
	// call super
	//alert(sXmlSrc +  " :  " +  sAction);
	this.WebFXTree = WebFXTree;
	this.WebFXTree(sText, sIdentifier, sIsRootCheckBox, sAction, sBehavior, sIcon, sOpenIcon);
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, sCheckBoxValue, eParent, sIcon, sOpenIcon) {
	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, sCheckBoxValue, eParent, sIcon, sOpenIcon);
...
function _xmlTreeToJsTree(oNode) {
	...
	var checkBoxValue = oNode.getAttribute("identifier");
	var parent = null;
	...
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, checkBoxValue, parent, icon, openIcon);
	else
		jsNode = new WebFXTreeItem(text, action, checkBoxValue, parent, icon, openIcon);
