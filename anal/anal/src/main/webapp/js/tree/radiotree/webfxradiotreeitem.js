...
function WebFXRadioTreeItem(sText, sAction, bChecked, eParent, sIcon, sOpenIcon) {
...
WebFXRadioTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	str += "<input type=\"radio\"" +
		...
		" onclick=\"webFXTreeHandler.all[this.parentNode.id].setChecked(this.checked);handleCheck( this ,'" + this.action + "' ,'"+ this.text + "') \"" +
		" />";
	// end insert radio
