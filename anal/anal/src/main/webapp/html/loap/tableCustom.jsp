...
//		var loapLeftTop = targObj.parent.parent.document.all[targObj.parent.name];
		var olapself = targObj.parent.document.all["leftButtomLoadIframe2"];
		
		if(targWin != null) {
			//var HeightValue = targObj.document.body.scrollHeight
			if(HeightValue < 600){HeightValue = 600;} //不小于600
		  if(olapself!=null) {
		  		olapself.style.pixelHeight = HeightValue + 20;
		  }
			targWin.style.pixelHeight = HeightValue+ 470;
		}
