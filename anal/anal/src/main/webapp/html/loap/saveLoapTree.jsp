...
function onCheck(e, treeId, treeNode) {
	...
	top.document.getElementById("topCsId").value= treeNode.id;
...
function viewTreeDirectory(){
	$.ajax({
		type : "POST",
		async : true,
		url   :  base+"/manage/loap/loapAction!viewAllTree."+actionExt,
		contentType: "application/x-www-form-urlencoded; charset=utf-8", 
	//	data : "rid="+$("#rid").val(),
		dataType : "json",
		success : function(msg) {
...
$(document).ready(function(){
	...
	<body>
		<div>
			<ul id="saveLoapTree" class="ztree" style="margin-top:0px;width:96%;height:238px;"></ul>
		</div>
	</body>
</html>
