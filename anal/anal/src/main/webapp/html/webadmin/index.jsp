...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main-iframe">
    	<tr>
         <td width="149" id="leftTab">
					<iframe name="left" id="left" src="${base}/manage/common/department/listDepartmentTree!initDepartment.${actionExt}?kind=admin" width="100%" height="100%" marginwidth="0" framespacing="0" marginheight="0" frameborder="0" scrlling="auto">
		 ...
		 <td width="12" align="left"
		  ...
		  <td id="contentTab" >
					<iframe name="right1" src="${base}/manage/safemanage/webadmin/listWebAdminAction.${actionExt}" width="100%" height="100%" marginwidth="0" framespacing="0" marginheight="0" frameborder="0" scrolling="auto" hspace="0" vspace="0">
					浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。	
					</iframe>
	</td>
</tr>
