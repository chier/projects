 ...
 * 
 */
Ext.define("Sencha.view.basicInfo.Panel2012_1", {
	extend : 'Ext.Panel',
    xtype : 'panel2012_1',
	config : {
		yearType:2012,
		items:[{
			cls:'map_2012',
			html:
			      '<h1 style="font-size: 38px;font-family: \'微软雅黑\';">2012年试点调查地区污染及行业类型</h1>'+
			      '<div class="fenl">'+
...
//		        '<h1 class=mapl_orange style="margin: 475px 0px 0px 581px;font-size:12px;"><a href="#">广西 </a></h1>'+
		        '<div class="clear"></div>'+
		        '<div class="map_con">'+
		        	'<p>综合考虑污染类型、特征污染物、调查点的区域代表性、已有工作基础及可行性，2011年选择重金属、有机污染、复合污染三种污染类型在8个试点地区开展调查</p>'+
		        '</div>'
