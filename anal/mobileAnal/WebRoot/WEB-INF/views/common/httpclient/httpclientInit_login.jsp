		...
		<form id='urlForm' action='<%=request.getContextPath()%>/common/httpclient/getHtml.talent' method='POST'>
			...
			<table class='tt_queryTable' id='tt_queryTable'>
				<tr>
					...
					<td  class='tt_queryTable_input'>
						<textarea id='tt_request_url'  name='tt_request_url' style='width:400px'></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan='1' class='tt_queryTable_input'>
						<textarea style='width:400px' name='tt_requestbody'>{"data":{"account":"admins", "password":"aaa111"}}</textarea>
					</td>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/app-res/common/httpclient/httpclientInit_login.js"></script>
