Ext.define("Sencha.view.deptinfo.LeftMainPanel", {
	extend : "Ext.Panel",
	requires : ['Sencha.view.deptinfo.LeftButtonPanel'],
	...
	config : {
		...
		, {
			...
			items : [{
				...
				//style : 'border:2px solid red',
				width : '45%',
				html : '<div style="padding:5px;"><canvas id="canvasDeptInfo" style="height:130px;border:0px solid red;"></canvas></div>',
			}, {
				xtype : 'panel',
			...
			items : [{
				xtype : 'panel',
				height : '10%',
				html : '<h2 style="padding:0 30px;" class="detail_title">机票+酒店</h2>'
			}//,         leftButtonPanel
			,{
