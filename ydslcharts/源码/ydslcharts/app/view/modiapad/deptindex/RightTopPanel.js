Ext.define("Sencha.view.modiapad.deptindex.RightTopPanel", {
	extend : "Ext.tab.Panel",
	xtype : 'DeptIndexRightTopPanel',
	requires : [
		'Ext.tab.Panel',
		'Sencha.view.modiapad.deptindex.DeptIndexLineChart',
		'Sencha.view.modiapad.deptindex.DeptIndexBarChart'
	],
	config : {
