Ext.define("Sencha.view.modiapad.flight.LeftBottomPiesPanel", {
	extend : 'Ext.Panel',
	requires : [
		'Sencha.view.modiapad.flight.CabinPiePanel', 
		'Sencha.view.modiapad.flight.AirLinePiePanel',
		'Sencha.view.modiapad.flight.ArrivedPiePanel'
	],
	...
	config : {
		...
		items : [{
				    ...
				    items:[
				    {
				    	...
				    	width:'33%',
						cls:'btn_con3_on',
				    	html:'<div style="height:35px;line-height:30px;"><em class="t_icon2"></em><span class="f_left">航空</span></div>',
				    	id:'hangkonggognsi',
				    	handler:function(){
				    		btnChange('airline');
