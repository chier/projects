Ext.define('Sencha.controller.Main', {
	...
	getData : function(button) {
		...
		if(this.isFlightInfoPage()) {
			 ...
			 */
			var AirLinePieProxyStore_param = '{"op":"Flight.flightAirlinePieChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{ ' + '"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
			 ...
			 */
			var ArrivedPieProxyStore_param = '{"op":"Flight.flightOffPointPieChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{ ' + '"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
			 ...
			 * 点击时间 舱位 发生变化
			 */
			var CabinPieProxyStore_param = '{"op":"Flight.flightCabinPieChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{ ' + '"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		...
		if(this.isHotelInfoPage()) {
			...
			var the_param = '{"op":"Hotel.hotelStarPieChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{ ' + '"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		...
		// 	store.removeAll();
			...
			var CityPie_param = '{"op":"Hotel.hotelCityPieChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{ ' + '"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
	...
	clickCanvasIndex : function(scope, number, type) {
		...
		var _type = type || 1;
		if(_type === 1) {
			the_param = '{"op":"Flight.detailChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		} else {
			the_param = '{"op":"Hotel.detailChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		}
		var dataArr = [];
		Ext.data.JsonP.request({
			url : Global.URL,
	...
	getSaleTotalDetailInIndex : function(scope, number, type) {
		...
		if(_type === 0) {
			...
			the_param = '{"op":"Report.detail","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		} else if(_type === 1) {
			indexGridView.setColumns([{
				header : '日期',
				dataIndex : 'date',
			...
			the_param = '{"op":"Flight.totalDetail","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		} else {
			indexGridView.setColumns([{
				header : '日期',
				dataIndex : 'date',
			...
			the_param = '{"op":"Hotel.totalDetail","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		}
	...
	*/
	...
	totalMoneyIndex : function(scope, number, type, btnType) {
		...
		var the_param;
		if(_type === 0) {
			the_param = '{"op":"Report.detailChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		} else if(_type === 1) {
			the_param = '{"op":"Flight.detailChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
		} else {
			the_param = '{"op":"Hotel.detailChart","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
	...
	getTicketDataForLine : function(scope, number, type, element) {
		...
		var the_param;
		if(_type === 'cabin') {
			the_param = '{"op":"Flight.flightCabin","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';

		} else if(_type === 'airLine') {
			the_param = '{"op":"Flight.flightAirline","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';

		} else {
			the_param = '{"op":"Flight.flightOffPoint","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
...
//						console.info(dataArr_flightTotal2);
	...
	getHotelDataForLine : function(scope, number, type,element) {
		...
		var _element = element;
		if(_type === 'star') {
			the_param = '{"op":"Hotel.hotelStar","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';

		} else {
			the_param = '{"op":"Hotel.hotelCity","source_id":"1","view_id":"' + Global.ViewId + '","data":{"year":2013,"scope":"' + _scope + '", "number":' + _number + '}}';
